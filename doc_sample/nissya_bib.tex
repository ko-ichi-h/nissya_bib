...
\usepackage{../nissya_bib_z} % カッコを全角に
...
文献注（citation）のカッコを全角で出力したい場合は、プリアンブルで\verb| \usepackage{nissya_bib} |としたあとに、\verb| \usepackage{nissya_bib_z} |を加えて下さい。本スタイルファイルを用いると外国人著者名を出力する際、ファーストネームとミドルネームは、そのイニシャルのみが出力されます。
...
なお、\verb|\citet{}|コマンドが外国人著者のフルネームを出力する場合、ファーストネームとミドルネームのイニシャル、ラストネームの順で著者名が出力されます。
...
一回目(和) & \verb|\citet{higuchi2020}| & \citet{higuchi2020} \\
二回目以降(和) & \verb|\citet{higuchi2020}| & \citet{higuchi2020} \\
...
なお、\verb|\citep{}|コマンドが外国人著者のフルネームを出力する場合は、『社会学評論』の規定に従って、常にファミリーネーム，イニシャルという出力になります。
...
\begin{tabular}{lll} \hline
\em コメント & \em 入力 & \em 出力\\ \hline
著者1名の場合 & \verb|\citep{higuchi2020}| & \citep{higuchi2020} \\
...
フルネームを強制（和） & \verb|\citep*{higuchi2020}| & \citep*{higuchi2020} \\
ページ数つき & \verb|\citep[42-3]{cmcjdb44}| & \citep[42-3]{cmcjdb44} \\
列挙 & \verb|\citep{kwbt1,hgc3,higuchi2020}| & \citep{kwbt1,hgc3,higuchi2020} \\
\hline
\end{tabular}
\end{center}
\end{table}
...
2022年4月に\citet{higuchi2020}で使用したバージョンに更新しました。修正した点は多数あるため、詳細はgithubにてdiffをご覧ください。
